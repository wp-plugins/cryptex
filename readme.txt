...
3. Go to Settings -> Cryptex Obfuscator. In th<e System Info section the first 3 items should be green (*GD Lib installed*, *GD Version*, *PNG Support*) - if not, you cannot using cryptex until you or your hosting provider install the GD library with enabled PNG support. At this time it is normal that *fonts avaible* and *system font path* are marked red.
